...
export default function MenuPage() {
  ...
  const styles = {
    ...
    headerTop: { padding: '20px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' },
    ...
    categories: { padding: '0 24px 20px', overflowX: 'auto', display: 'flex', gap: '0' },
    ...
    menu: { padding: '24px', paddingBottom: '160px' },
    ...
    floatingCart: { position: 'fixed', bottom: '24px', left: '24px', right: '24px', zIndex: 30 },
    ...
    cartHeader: { padding: '24px', borderBottom: `1px solid ${colors.border}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' },
    cartTitle: { fontSize: '14px', fontWeight: '400', letterSpacing: '4px', textTransform: 'uppercase' },
    cartItems: { padding: '24px', overflowY: 'auto', flex: 1 },
    cartItem: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 0', borderBottom: `1px solid ${colors.border}` },
    cartFooter: { padding: '24px', borderTop: `1px solid ${colors.border}` },
